...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-JKLongPressReorderableTableViewCategory_Example/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'JKLongPressReorderableTableViewCategory.framework'
fi
